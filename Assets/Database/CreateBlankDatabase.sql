...
VALUES (0, 300, 3, 6000, 10, 1, 1, .8, '30;30', 0);
INSERT INTO MatchConfig (id, matchTimeout, winnerPollPeriod, initialRange, initialSpeed, randomInitialSpeed, competitorsPerTeam, stepForwardProportion, locationRandomisationRadiai, randomiseRotation)
VALUES (1, 300, 3, 6000, 10, 1, 1, .8, '30;30', 0);
INSERT INTO MatchConfig (id, matchTimeout, winnerPollPeriod, initialRange, initialSpeed, randomInitialSpeed, competitorsPerTeam, stepForwardProportion, locationRandomisationRadiai, randomiseRotation)
VALUES (2, 120, 3, 6000, 10, 1, 1, .8, '30;30', 0);
INSERT INTO MatchConfig (id, matchTimeout, winnerPollPeriod, initialRange, initialSpeed, randomInitialSpeed, competitorsPerTeam, stepForwardProportion, locationRandomisationRadiai, randomiseRotation)
VALUES (2, 180, 3, 8000, 5, .5, 2, .9, '100', 0);
...
INSERT INTO MutationConfig (id, mutations, allowedCharacters, maxMutationLength, genomeLength, generationSize, randomDefault, defaultGenome) VALUES (0, 3, ' 0123456789012  ', 5, 300, 17, 0, '');
