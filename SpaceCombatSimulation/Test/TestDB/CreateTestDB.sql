...
CREATE TABLE BrEvolutionConfig (id INTEGER PRIMARY KEY REFERENCES BaseEvolutionConfig (id) ON DELETE CASCADE NOT NULL, combatants INTEGER NOT NULL DEFAULT (2), inSphereRandomisationRadius FLOAT NOT NULL DEFAULT (0), onSphereRandomisationRadius FLOAT NOT NULL DEFAULT (0), raceMaxDistance FLOAT NOT NULL DEFAULT (2000), raceScoreMultiplier FLOAT NOT NULL DEFAULT (1000), raceGoalObject INTEGER, survivalBonus FLOAT NOT NULL DEFAULT (400), deathScoreMultiplier FLOAT NOT NULL DEFAULT (1));
INSERT INTO BrEvolutionConfig (id, combatants, inSphereRandomisationRadius, onSphereRandomisationRadius, raceMaxDistance, raceScoreMultiplier, raceGoalObject, survivalBonus, deathScoreMultiplier) VALUES (2, 2, 106, 107, 2010, 1003, 4, 42, 1.5);
INSERT INTO BrEvolutionConfig (id, combatants, inSphereRandomisationRadius, onSphereRandomisationRadius, raceMaxDistance, raceScoreMultiplier, raceGoalObject, survivalBonus, deathScoreMultiplier) VALUES (3, 4, 207, 208, 2011, 1013, NULL, 421, 11.5);
