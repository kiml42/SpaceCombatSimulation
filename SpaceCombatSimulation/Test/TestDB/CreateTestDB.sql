...
CREATE TABLE BrEvolutionConfig (id INTEGER PRIMARY KEY REFERENCES BaseEvolutionConfig (id) ON DELETE CASCADE NOT NULL, combatants INTEGER DEFAULT '''2''' NOT NULL, inSphereRandomisationRadius FLOAT DEFAULT '0' NOT NULL, onSphereRandomisationRadius FLOAT DEFAULT '0' NOT NULL);
