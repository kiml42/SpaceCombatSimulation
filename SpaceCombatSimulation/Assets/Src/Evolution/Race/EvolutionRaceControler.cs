...
{
    public class EvolutionRaceControler
    {
        ...
        public GeneralDatabaseHandler DbHandler
        {
            get
            {
                return _dbHandler;
        ...
        protected BaseEvolutionConfig BaseConfig
        {
            get
            {
                return _config;
        ...
        public IEnumerable<string> Combatants
        {
            get
            {
